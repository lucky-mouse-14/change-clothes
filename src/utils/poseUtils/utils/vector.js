...
export default class Vector {
  ...
  /**
   * Subtract a vector or number from this vector.
  ...
  /**
   * To Angles
   * @typedef {Object} AxisMap
   * @property {string} x - x of the AxisMap.
   * @property {string} y - y of the AxisMap.
   * @property {string} z - z of the AxisMap.
